...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
	 ...
	 <div class="item">
      <img src="images/Notice002.jpg" alt="...">
      <div class="carousel-caption">
        ...
      </div>
    </div>
...
<div class="container">
	...
	<!-- container -->
		...
		{
		echo "<h2><b>ONLINE NOTICE BOARD</b></h2>
		<i> <b>To know your personal Notice/ Update check your account daily!!</b></i>";
		}
		?>
  ...
  College will now open on 10th feb offline and till then all the students are supposed to attend online lectures compulsory and 75% attendance is needed to appear first Unit test!!
  </div>
</div>
